...
Original Source: Raw historical data containing dates, financial categories, and amounts.

Workings: Data cleaning and mapping layer where raw data is categorized into financial headers (e.g., mapping "Cogs - Supermarkets" to "Cost of goods sold").

Historical Financials:

BS 2014 / 2015 / 2016: Granular historical Balance Sheets used as the baseline for the model.

Integrated Model & Forecasts:

P&L (Profit & Loss): Historicals and 5-year forecasts. Features scenario toggles (e.g., "Best Case") and margin analysis.

BS (Balance Sheet): Integrated forecast including working capital ratios (DSO, DPO, DIO) and cash flow integration.

Supporting Schedules:

Fixed Assets Roll Forward: Tracks PP&E, Depreciation & Amortization (D&A), and Capital Expenditures (Capex).
...
Efficiency Metrics: The model tracks operational efficiency with stabilized inventory days (DIO) and receivable days (DSO) forecasted through 2021.
...
Data Mapping: Transforming unstructured raw data into standardized financial reporting formats.

Scenario Analysis: Implementation of "Best Case" and other scenario toggles to stress-test the forecast.
...
Audit Schedules: Check the Fixed Assets and Financial Liabilities tabs to see how D&A and Interest expenses flow into the P&L and Balance Sheet.
...
📢 Disclaimer
This model is for educational and analytical purposes only. The projections are based on historical assumptions and hypothetical scenarios; actual results may vary significantly based on market conditions and operational changes.
